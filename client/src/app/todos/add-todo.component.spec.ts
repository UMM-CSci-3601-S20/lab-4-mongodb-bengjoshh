...
describe('AddTodoComponent', () => {
  ...
  describe('The owner field', () => {
    ...
    it('should fail if we provide an "existing" owner\'s name', () => {
  ...
  describe('The status field', () => {
    ...
    it('should fail on status that are strings', () => {
      statusControl.setValue('"hello world"');
      expect(statusControl.valid).toBeFalsy();
    });

    it('should not allow a status to contain digits', () => {
      statusControl.setValue('123567');
      expect(statusControl.valid).toBeFalsy();
  ...
  describe('The category field', () => {
    ...
    it('should not accept emails', () => {
      categoryControl.setValue('conniestewart@ohmnet.com');
      expect(categoryControl.valid).toBeFalsy();
    });
